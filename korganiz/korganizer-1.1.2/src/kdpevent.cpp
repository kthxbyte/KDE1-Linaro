// 	$Id: kdpevent.cpp,v 1.78.2.1 1999/04/05 20:43:11 glenebob Exp $	
...
QString KDPEvent::getDtStartDateStr() const
{
  ...
  dateStr.sprintf("%.2d %3s %4d",dtStart.date().day(),
		  dtStart.date().monthName(dtStart.date().month()),
		  dtStart.date().year());
  return dateStr;
}
...
QString KDPEvent::getDtEndDateStr() const
{
  ...
  dateStr.sprintf("%.2d %3s %4d",dtEnd.date().day(),
		  dtEnd.date().monthName(dtEnd.date().month()),
		  dtEnd.date().year());
  return dateStr;
}
...
QString KDPEvent::getRecursEndDateStr() const
{
  ...
  dateStr.sprintf("%.2d %3s %4d",rEndDate.day(),
		  rEndDate.monthName(rEndDate.month()),
		  rEndDate.year());
  return dateStr;
}
