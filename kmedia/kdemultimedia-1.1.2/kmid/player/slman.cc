...
int SLManager::nameUsed(char *name)
{
    /*
...
void SLManager::changeCollectionName(int id,char *newname)
{
    if (id<1) return;
    if (nameUsed(newname))
    {
...
SongList *SLManager::getCollection(char *name)
{
    SongListNode *ptr=list;
...
char *SLManager::getCollectionName(int id)
{
