...
extern int	perrno;
extern char	p_err_string[P_ERR_STRING_SZ];
extern char	*p_err_text[P_ERR_STRING_SZ];

extern int	pwarn;
extern char	p_warn_string[P_ERR_STRING_SZ];
extern char	*p_warn_text[P_ERR_STRING_SZ];
